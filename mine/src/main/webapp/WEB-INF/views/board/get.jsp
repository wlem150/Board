			...
			<div class="panel-body">
				<ul class="chat">
					<li class="left clearfix" data-rno='12'>
						<div>
							<div class="header">
								<strong class="primary-font"> user00 <small
									class="pull-right text-muted">2023-06-10 11:20</small>
								</strong>
							</div>
							<p>Good job!</p>
						</div>
	    ...
	    replyService.getList(
	      ...
	      function (replyCnt, list) {
	        ...
	        for (var i = 0, len = list.length || 0; i < len; i++) {
	          ...
	          str +=
	            " <div><div class='header'><string class='primary-font'>" +
	            list[i].replyer +
	            "</string>";
	          str +=
